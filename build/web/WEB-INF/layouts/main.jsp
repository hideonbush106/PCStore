                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="menu">
                                            <nav>
                                                <ul>
                                                    <li>  <a href="<c:url value="/admin/index.do" />">Home</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="menu">
                                            <nav>
                                                <ul>
                                                    <li>  <a href="<c:url value="/employees/index.do" />">Home</a></li>
                                                    <li><a href="<c:url value="/employees/orderList.do" />">Order List</a></li>
